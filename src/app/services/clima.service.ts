...
export class ClimaService {
   ...
   * (en intervalos de 3 horas desde 00:00), entonces las 40 posiciones representan 5 días.
   ...
   * @param ciudadBuscada 
   * @param unidad - sistema métrico utilizado para mostrar los datos. Métrico o imperial.
