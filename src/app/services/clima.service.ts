...
export class ClimaService {
   ...
   * https://positionstack.com/documentation : API de geocodificación.
   ...
   * @returns - devuelve un vector de 40 posiciones: los 8 intervalos (de 3 horas) por día, dando 5 días.
   */
   ...
   * @param {string} unidad - sistema de medición utilizado para mostrar los datos. Métrico o imperial.
   * @param {string} idioma - español o inglés.
   * @returns - devuelve un único valor: la temperatura de la hora actual.
   */
  ...
  /**
   * @function getMapa - obtiene mapa de la API (se configura su composición en mapa.page.html).
   * @returns - devuelve un mapa. 
   */
  getMapa() {
    return this.clienteHttp.get(this.key_LIQ);
  }
}